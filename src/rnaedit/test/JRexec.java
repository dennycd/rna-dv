...
public class JRexec implements Runnable {
  ...
  public JRexec(String user, String host, String passwd, String command, boolean auxport)
  ...
  public JRexec(String user, String host, String passwd, String command,
		boolean auxport, InputStream data)
    throws JRexecException {
    this(user, host, passwd, command, auxport);
    this.data=data;
  }
  public JRexec(String user, String host, String passwd, String command,
		boolean auxport, String data)
    throws JRexecException {
  ...
  public InputStream getAuxInputStream (){ return auxin;}
  public OutputStream getAuxOutputStream (){ return auxout;}
...
/*
  public static void main(String arg[]){
    try	{    
      JRexec jrexec=new JRexec("yamanaka", "localhost", "????", "du /");
...
/*
  public static void main(String arg[]){
    try	{    
      ...
      jrexec.addListener(
        new JRexecListener(){
 	  public void output(String s){System.out.println("output: "+s);}
